                            ...
                            <div class="col-md-3 text-center">
                                <% if (photoPath != null && !photoPath.isEmpty()) { %>
                                    <img src="<%= photoPath %>" alt="Doctor Photo" class="doctor-photo"
                                         onerror="this.style.display='none'; document.getElementById('drInitFb').style.display='flex';">
                                    <div id="drInitFb" class="doctor-avatar-initials" style="display:none;"><%= drInitials %></div>
                                <% } else { %>
                                    <div class="doctor-avatar-initials"><%= drInitials %></div>
                                <% } %>
                            </div>
